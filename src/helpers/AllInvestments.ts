...
export const usdb_ftmSafe = new TokenInvestment({
  name: "usdb",
  displayName: "USDB",
  decimals: 18,
  isLp: false,
...
export const usdb_ethSafe = new TokenInvestment({
  name: "usdb_eth",
  displayName: "USDB",
  decimals: 18,
  isLp: false,
  ...
  chainId: NetworkIds.Ethereum,
  chainName: "ethereum",
  contractAddress: "0x02B5453D92B730F29a86A0D5ef6e930c4Cf8860B",
  daoAddress: "0x66a98CfCd5A0dCB4E578089E1D89134A3124F0b1",
  customAssetPriceFunc: async function (this: TokenInvestment) {
    return 1;
  },
...
export const usdb_dai_lp2 = new TokenInvestment({
  name: "usdb-dai-lp",
  ...
  chainId: NetworkIds.FantomOpera,
  chainName: "fantom",
  contractAddress: "0x955e91c5a7a05E5C790449cc43b1d1519965517C",
  daoAddress: "0x34f93b12ca2e13c6e64f45cfa36eabadd0ba30fc",
  customAssetPriceFunc: async function (this: TokenInvestment) {
    return 1;
  },
