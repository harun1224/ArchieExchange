...
import { bannerStatus } from "../../helpers";
...
function NavContent() {
  ...
  const { crystalBall, fhudToUsdb } = useFlags();
  ...
  const checkPage = useCallback((match, location, page) => {
    ...
    if (currentPath.indexOf("dashboard") >= 0 && page === "dashboard") {
     ...
     if (currentPath.indexOf("stake66") >= 0 && page === "stake66") {
       return true;
     }
     if (currentPath.indexOf("stake") >= 0 && currentPath.indexOf("stake66") < 0 && page === "stake") {
       return true;
     }
    ...
    <Paper className="dapp-sidebar">
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header" sx={{mt: `${bannerStatus() ? "100px" : "30px"}`}}>
            ...
            <div className="dapp-nav" id="navbarNav" key="navbarNav">
              ...
              {enabledNetworkIdsExceptDexOnly.indexOf(chainId) >= 0 && [
                ...
                >
                  ...
                  ,
                <div className="dapp-menu-data staking-options">
                  <div className="staking-opts">
                    <Link component={NavLink}
                      id="stake"
                      to="/stake"
                      isActive={(match, location) => { return checkPage(match, location, "stake");}}
                      className={`stake ${isActive ? "active" : ""}`}>
                        <Typography variant="body2">
                        Single Stake
                        <span className="stake-option">
                        ( 3,3 )
                        </span>
                        </Typography>
                      </Link>
                      ...
                      {/*  to="/stake66"*/}
                      {/*  isActive={(match, location) => {*/}
                      {/*  return checkPage(match, location, "stake66");*/}
                      {/*}}*/}
                      {/*  className={`stake ${isActive ? "active" : ""}`}>*/}
                      {/*  <Typography variant="body2">*/}
                      {/*  30 Days Stake*/}
