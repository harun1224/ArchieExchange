      ...
      <div className={ `app ${ isSmallerScreen && "tablet" } ${ isSmallScreen && "mobile" } 
        ...
        <div className={ `${ classes.content } ${ isSmallerScreen && classes.contentShift }
          ...
          <Switch>
            ...
            <Route exact path="/">
              { (enabledNetworkIdsExceptDexOnly.indexOf(chainId) >= 0 && <Redirect to="/dex" />) || (
                  <Redirect to="/dex" />
              ) }
            </Route>
            ...
            {/* <Route exact path="/">
              { (enabledNetworkIdsExceptDexOnly.indexOf(chainId) >= 0 && <Redirect to="/stake66" />) || (
                  <Redirect to="/dex" />
              ) }
            </Route> */}

            {/* <Route path="/stake66">
              { (enabledNetworkIdsExceptDexOnly.indexOf(chainId) >= 0 && <Stake30Days />) || (
                  <Redirect to="/dex" />
              ) }
            </Route>
