...
export const networks: INetworks = {
  [NetworkIds.FantomOpera]: {
    ...
    isTestNet: false,
    epochBlock: 20187783,
    blocktime: 1.03, // https://ftmscan.com/chart/blocktime
    epochInterval: 28800,
    ...
    addresses: {
      ...
      STAKING_REWARDS_HOLDER_ADDRESS : "0xf3162417A5645ebd1A4553e5Be06Ef13d6a7dA95",
      STAKINGSTAKING_ADDRESS : "0x32bA75D49206b3A7123A5a38Eac0A77b9e205a51"
  ...
  [NetworkIds.FantomTestnet]: {
    ...
    addresses: {
      ...
      STAKINGSTAKING_ADDRESS: "0x270f8d486648d6d3e5d6a685331154Ee15574f63",
      STAKING_REWARDS_HOLDER_ADDRESS: "0xB3a1387cDB0CeDD67A542f4f39518652419621cc",
  ...
  //   isEnabled: true,
  //   isTestNet: false,
  //   blocktime: 25.52, // https://moonriver.moonscan.io/chart/blocktime
  //   epochBlock: 979500,
  //   epochInterval: 1960,
