          ...
          <Box p="10px">
            <FormControl className="line-border w-full" variant="standard"
              ...
              <OutlinedInput
                ...
                style={ { fontSize: "20px", color: 'white', borderColor: 'white' } }
                notchedOutline={ true }
              />
            </FormControl>
          </Box>
          <Box px="10px" my="10px">
            <Typography variant="h6" color="textSecondary">Assets</Typography>
          </Box>
                      ...
                      <Box display="flex" className="cursor-pointer" justifyContent="space-between" alignItems="center" mb="10px"
                        ...
                        <Box display="flex">
                          ...
                          <Box display="flex" flexDirection="column" ml="5px" justifyContent="center">
                            <Typography variant="h6" color="textSecondary">{ token?.symbol } ({ token?.blockchain })</Typography>
                            <Typography style={ { fontSize: "10px" } } color="textSecondary">{ token?.name }</Typography>
                          </Box>
                        </Box>
