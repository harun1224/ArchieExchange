    ...
    <Box>
      ...
      <Box display="flex" mt="5px" mb="20px" flexWrap={ { xs: "wrap", sm: "nowrap" } }
        ...
        <Box flex={ { xs: "100%", sm: "100%" } } pr={ { sm: "5px" } }>
          <Box display="flex" alignItems="center" justifyContent="end" px="15px" className="line-border fromTokenBox" height="78px">
        ...
        <Box flex={ { xs: "100%", sm: "90px" } } className="line-border fromTokenBox" display="flex" py="10px"
