    ...
    <Box>
      ...
      <Box display="flex" mt="5px" flexWrap={ { xs: "wrap", sm: "nowrap" } }
        ...
        <Box flex={ { xs: "100%", sm: "100%" } } pr={ { sm: "5px" } }>
          <Box display="flex" alignItems="center" px="15px" className="line-border toTokenBox" height="78px">
        ...
        <Box flex={ { xs: "100%", sm: "90px" } } className="line-border toTokenBox" display="flex" py="10px"
