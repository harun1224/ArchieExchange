...
function Bond({ bond }) {
  ...
  useEffect(() => {
    setView((Number(bond.pendingPayout) > 0 || Number(bond.interestDue) > 0) ? 1 : 0);
  }, [bond.interestDue, bond.pendingPayout]);
          ...
          <Fade in={true}>
            <Paper className="ohm-card ohm-modal">
              ...
              <Box direction="row" className="bond-price-data-row">
                {(!bond.isFhud || bond.name === "usdbFhmBurn") && <div className="bond-price-data">
                ...
                {(bond.name !== "usdbFhmBurn") && <div className="bond-price-data">
                  <Typography variant="h5" color="textSecondary">
                    Market Price
                  </Typography>
              ...
              >
                <Tab label={bond.bondAction} {...a11yProps(0)} />
                <Tab label={bond.redeemAction} {...a11yProps(1)} />
              </Tabs>
