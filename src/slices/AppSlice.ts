...
import { findOrLoadMarketPrice, loadNetworkDetails } from "./NetworkSlice";
...
export const loadAppDetails = createAsyncThunk(
	...
	async ({ networkId }: IBaseAsyncThunk, {dispatch}) => {
		...
		return {
			...
			thirtyDayRate: localNetworkDetails.thirtyDayRate,
			...
			blocksPerSample: localNetworkDetails.blocksPerSample,
			actualRewards: localNetworkDetails.actualRewards,
			thirtyDayTVL: localNetworkDetails.thirtyDayTVL,
		} as IAppData;
    },
);
...
interface IAppData {
    ...
    readonly lastSampleBlockNumber: number;
    readonly stakingStakingAPY: number;
