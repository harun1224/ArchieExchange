...
const usdbdaiv2 = new GraphToken({
  name: 'usdb_dai_lp_v2',
  graphKey: 'USDBDAIV2',
  displayName: 'USDB-DAI',
  stopColor: ['#2e49ab', '#b3f20b'],
...
export const ftmGraph: Graph = new Graph(
  'FTM',
  'Fantom',
  'https://api.thegraph.com/subgraphs/id/QmYM1oGqRneiqibuFxJakkMRRo1Tuhw3H4f5g1YrVWGVWv',
  [dai, mim, fhud, sspell, wftm, fhuddailp, usdb, usdbdai, usdbdaiv2],
  [fhmdai, fhmmim],
  [wmemo, dai, fhud, usdb],
);
